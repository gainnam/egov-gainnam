...
public class MemberTest {
	...
	public void updateMember() throws Exception {
		...
		memberVO.setORGNZT_ID("ORGNZT_0000000000000");//외래키이기때문에ㅋ
	...
	public void insertMember() throws Exception {
		...
		pageVO.setqueryPerPageNum(10000);//JUnit test전용으로 10000정도해서 에러안나게
		...
		memberVO.setGROUP_ID("GROUP_00000000000000");//외래키이기때문에 부모테이블에 있는값을 넣어야 함.
		memberVO.setEMPLYR_STTUS_CODE("P");//회원상태코드 P-활성,S-비활성
		memberVO.setESNTL_ID("USRCNFRM_" + (memberList.size()+1));//고유ID이기때문에 중복되면 안됨
