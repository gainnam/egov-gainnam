...
$(document).ready(function(){
	//EMPLYR_ID중복체크 이후 submit버튼을 disabled->false로 활성화 시키면 전송이 가능Ajax
	//blur<->focus
	$("#EMPLYR_ID").bind("blur", function() {
		var emplyr_id = $(this).val();
		 
		$.ajax({
			url:"<c:url value='/' />idcheck.do?emplyr_id="+emplyr_id,//@Response사용하는 class의 메서드 매핑 url값
			type:"get",//jsp에서 contoller로 보내는 방식
			dataType:"text",//ajax결과를 controller class에서 받는 방식
