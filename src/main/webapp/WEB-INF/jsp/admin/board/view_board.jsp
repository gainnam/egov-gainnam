      ...
      <div class="container-fluid">
        ...
        <div class="row"><!-- 부트스트랩의 디자인 클래스 row -->
          ...
          <div class="card-body">
           	...
           	<button id="btn_delete" type="button" href="board_list.html" class="btn btn-danger float-right mr-1">삭제</button>
			<button id="btn_update" type="button" href="board_write.html" class="btn btn-warning float-right mr-1 text-white">수정</button>              	
          </div>
          <!-- 버튼영역 끝 -->
          </div><!-- //col-12 -->
        </div><!-- //row -->
