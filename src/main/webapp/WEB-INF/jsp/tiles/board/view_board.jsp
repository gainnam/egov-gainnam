...
<div id="container">
	...
	<div class="location_area customer">
		<div class="box_inner">
			...
			<p class="location">
				고객센터 <span class="path">/</span> ${brdMstrVO.bbsNm}
			</p>
			<ul class="page_menu clear">
				<li><a
					href="<c:url value='/tiles/board/list_board.do?bbsId=BBSMSTR_AAAAAAAAAAAA' />"
					class="<c:out value='${brdMstrVO.bbsId=="BBSMSTR_AAAAAAAAAAAA"?"on":""}' />">공지사항</a></li>
				<li><a
					href="<c:url value='/tiles/board/list_board.do?bbsId=BBSMSTR_BBBBBBBBBBBB' />"
					class="<c:out value='${brdMstrVO.bbsId=="BBSMSTR_BBBBBBBBBBBB"?"on":""}' />">겔러리</a></li>
			</ul>
		</div>
	</div>
	<!-- //메인상단위치표시영역 -->
	...
	<div class="bodytext_area box_inner">
		<ul class="bbsview_list">
			...
			<c:if test="${not empty result.atchFileId}">
				<li class="bbs_title">첨부파일: <c:import
						url="/cmm/fms/selectFileInfs.do" charEncoding="utf-8">
