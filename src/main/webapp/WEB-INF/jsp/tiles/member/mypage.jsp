				...
				<fieldset>
					...
					<ul class="app_list">
						<li class="clear">
							...
							<input value="${memberVO.EMPLYR_ID}" type="text" name="EMPLYR_ID" class="w100p" id="EMPLYR_ID" placeholder="아이디를 입력해주세요" required readonly/></div>
						</li>
						<li class="clear">
