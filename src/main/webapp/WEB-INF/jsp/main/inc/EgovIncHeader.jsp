...
<div id="logoarea">
	<h1>
		<a href="<c:url value='/cmm/main/mainPage.do' />"><img
			src="<c:url value='/images/header/logo.jpg' />" alt="템플릿 샘플 홈페이지"
			height="30" /></a>
	</h1>
</div>
<!-- 
...
<div id="project_title">
	<span class="maintitle">표준프레임워크 </span><strong>샘플 홈페이지 </strong> <a
		href="<c:url value='/EgovPageLink.do?link=main/sample_menu/Intro'/>"
		target="_blank"><img width="20" height="20"
		src="<c:url value='/images/question.jpg'/>" alt="메뉴구성 설명"
		title="메뉴구성 설명"></a>
</div>
<!-- //행정안전부 로고 및 타이틀 끝 -->
<div class="header_login">
	...
	<div id="header_loginname">
		<a href="<c:url value='/tiles/home.do' />">NEW전자정부사이트</a>&nbsp;
		<a href="#LINK"
			onclick="location.replace('<c:url value="/" />admin/home.do'); return false;"><c:out
				value="${loginName}" /> 님</a>
	</div>
	...
	<ul class="login_bg_area">
		<li class="righttop_bgleft">&nbsp;</li>
		<li class="righttop_bgmiddle"><a
			href="<c:url value='/uat/uia/actionLogout.do'/>">로그아웃</a></li>
		<li class="righttop_bgright">&nbsp;</li>
	</ul>
	<% } %>
</div>